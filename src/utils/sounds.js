...
const initAudio = () => {
  try {
    ...
    // Browser blocked AudioContext creation (e.g. strict autoplay policy)
    console.warn('[sounds] AudioContext init failed:', err);
    return false;
  }
};
...
export const playSound = (type) => {
  try {
    ...
    // Silently swallow sound errors — they should never break gameplay
