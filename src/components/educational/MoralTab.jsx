...
import { moralActivities } from '../../kids-data.js';
import { playSound } from '../../utils/sounds.js';

export default function MoralTab() {
  const [activeActivityId, setActiveActivityId] = useState(null);
  const activeActivity = moralActivities.find((activity) => activity.id === activeActivityId);
